...
class LiveDAO(DAOImplementation):
    ...
    def _get_connect_timeout(self):
        ...
        """
        return float(self.dao.get_service_setting("CONNECT_TIMEOUT", 3))
    ...
    def _get_timeout(self):
        ...
        """
        return float(self.dao.get_service_setting("TIMEOUT", 2))

    def _get_max_pool_size(self):
        """
        The maximum connections per host.
        """
        return int(self.dao.get_service_setting("POOL_SIZE", 10))
